...
Series 생성 코드 document link 입니다. [pandas.Series](https://pandas.pydata.org/docs/reference/api/pandas.Series.html#pandas.Series)  
...
index 지정 없이 dict 객체만 가지고 Series를 만들 수도 있습니다. 그 경우 dic의 key가 index로 사용되는 됩니다.  
...
[NumPy Universal function]https://numpy.org/doc/stable/user/basics.ufuncs.html#ufuncs-basics  
