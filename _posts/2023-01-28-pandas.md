...
![image](https://user-images.githubusercontent.com/105477856/215304272-b6a155ff-f475-4ced-9bfa-9f07b88625e9.png)  
...
![image](https://user-images.githubusercontent.com/105477856/215304392-6ccdc96e-0cb4-48ee-8dc4-0e09f6bf03ca.png)
- qcut: 개수가 똑같은 구간으로 나누는 경우(분위수)
  - x = 1d ndarray 혹은 Series
  - q = int 혹은 분위수를 나타내는 1.이하의 실수를 요소로 갖는 list (e.g. [0, .25, .5, .75, 1.])    

![image](https://user-images.githubusercontent.com/105477856/215304410-1c5496fb-d4b6-4c3f-bdca-72854636143c.png)  

# 이 글은..
판다스를 정리하며 적는 리뷰 글입니다. 더 많은 자료는 아래 링크에서 확인해주세요!  
[파이썬 기본](https://github.com/jewoodev/python-basic-part)