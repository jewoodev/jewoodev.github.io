---
title : "AI 에이전트가 한 시간 뒤에 길을 잃는 이유 — Anthropic이 제시한 '세션 경계' 설계법"
date : 2026-04-08 21:40:00 +09:00
categories : [AI, Harness]
tags : [harness]
image:
  path: assets/img/AI-에이전트가-한-시간-뒤에-길을-잃는-이유—Anthropic이-제시한-'세션-경계'-설계법/cover.png
---
...
![](assets/img/AI-에이전트가-한-시간-뒤에-길을-잃는-이유—Anthropic이-제시한-'세션-경계'-설계법/아티팩트들과-7개의-워크플로우.png){: width="100%" }
...
![](assets/img/AI-에이전트가-한-시간-뒤에-길을-잃는-이유—Anthropic이-제시한-'세션-경계'-설계법/spec을-굳히는-세-시점.png){: width="100%" }
