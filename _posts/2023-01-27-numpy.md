...
![image](https://user-images.githubusercontent.com/105477856/221346151-550fc605-89dc-4bae-b52d-0793ae365320.png)  
...
![image](https://user-images.githubusercontent.com/105477856/221346274-943f42e1-6686-4f4b-b5f2-deff334f6cba.png)  
...
![image](https://user-images.githubusercontent.com/105477856/221346308-5678f427-361c-4fe7-876f-010e367d9877.png)  
...
![image](https://user-images.githubusercontent.com/105477856/221346380-f1881411-fa75-4762-9df8-58717b8f8226.png)  
  
넘파이 배열 객체의 벡터화 연산을 사용하면 다음과 같이 for 반복문이 없이 간단하게 단   
한번의 연산식으로 표현할 수 있습니다. 물론 계산 속도도 리스트 객체에 반복문을   
사용해서 처리하는 것보다 훨씬 빠릅니다.  
![image](https://user-images.githubusercontent.com/105477856/221346397-daeafdfb-3d6d-4567-afcc-e79d90f1218b.png)  
   
앞서 학습했던 내용으로 파이썬 리스트 객체에 정수를 곱하면```(*)``` 객체의 크기가 곱한  
숫자만큼 반복 증가합니다. 넘파이 배열 객체는 벡터화 연산이 이뤄진다고 바로 앞에서  
설명 드렸습니다. 이 차이점을 분명히 기억해둬야 합니다.  
![image](https://user-images.githubusercontent.com/105477856/221346407-bfe6cb71-6182-4b5f-b7bf-b9fbbad6c544.png)  
...
하진 않습니다.)  
![image](https://user-images.githubusercontent.com/105477856/221346483-441bf9d1-665e-49a5-8254-1bc7636b594d.png)  
...
![image](https://user-images.githubusercontent.com/105477856/221346498-f3aece0b-de45-4f97-a09a-e50dac2b8c74.png)  
...
- 2차원: 행 x 열
- 1차원: 열  
![image](https://user-images.githubusercontent.com/105477856/221346547-bc385ab1-32a0-46bb-8c04-f583fd16afff.png)  
출처: https://numpy.org/doc/stable/user/basics.broadcasting.html[링크](https://numpy.org/doc/stable/user/basics.broadcasting.html)  

브로드캐스팅이 불가능한 경우입니다. 이 경우 파이썬은 ValueError를 발생시킵니다.  
![image](https://user-images.githubusercontent.com/105477856/221346580-285227d4-d1ec-4d00-ac86-147ea9d19d81.png)  
...
사용할 수 있습니다.  
![image](https://user-images.githubusercontent.com/105477856/221346622-d8fb4bf8-f8bf-4fdd-bb36-95a838cb35f0.png)  
(참고) np.sum()과 ndarray.sum()은 동등한 메서드입니다.  
![image](https://user-images.githubusercontent.com/105477856/221346643-76a6bfb1-f7c3-4c49-bb03-7fedd696a6c0.png)  
![image](https://user-images.githubusercontent.com/105477856/221346654-53d0dd94-7575-4864-9f8f-e21ec32aee46.png)  

## 차원 축소 연산 - min()
min() 메서드는 해당 배열의 제일 작은 값의 결과를 반환합니다. 연산 대상이 2차원 이상일 때는 axis   
키워드 인수를 사용할 수 있습니다.   
![image](https://user-images.githubusercontent.com/105477856/221346678-d3ec460f-49ab-431d-8739-59a5b9c9ab0a.png)  

## 차원 축소 연산 - argmin()
argmin() 메서드는 해당 배열의 제일 작은 값의 인덱스를 반환합니다. 연산 대상이 2차원  
이상일 때에는 axis 키워드 인수를 사용할 수 있습니다.  
![image](https://user-images.githubusercontent.com/105477856/221346715-55b5aaec-8ded-4621-be2d-be6ac5b6f01a.png)  
